...
def start():
    ...
    # Add the study name to the final table output
    hv_family_df = hv_family_df.reset_index()
    hv_family_df.to_csv(f"{TABLE_OUTPUT_DIR}/hv_family_abun.csv", index=False)
